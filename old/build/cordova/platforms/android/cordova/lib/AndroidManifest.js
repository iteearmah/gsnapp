...
AndroidManifest.prototype.getTabrisActivity = function() {
  var activity = this.doc.getroot().find('./application/activity[@android:name="com.eclipsesource.tabris.android.TabrisActivity"]');
  return {
    setOrientation: function (orientation) {
      if (!orientation || orientation.toLowerCase() === DEFAULT_ORIENTATION) {
        delete activity.attrib['android:screenOrientation'];
